        ...
        child: Center(
          child: Container(
            ...
            decoration: BoxDecoration(
              color:
                  Colors.white.withOpacity(0.2), // Slightly transparent white
            ...
            child: Column(
              children: [
                const Bubbles(),
                const SizedBox(
                    height: 8), // Reduced spacing between title and items
                Expanded(
                  child: ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      return StoreElement(
                        ...
                        imagePath:
                            'assets/images/$index.png', // Updated to start from 0
                      );
                    },
                  ),
                ),
  ...
  Widget build(BuildContext context) {
    return Card(
      color: const Color.fromARGB(
          233, 255, 255, 255), // White background for the store item
